...
public class SettingsActivity extends AppCompatActivity {
    ...
    private TextInputLayout ilApiVersion;
    ...
    private ProgressBar pbApiPublicUrl;
    private ProgressBar pbApiLocalUrl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindViews();
        mSettings = new MySettings(getApplicationContext());
        init();
    }
    ...
    private void bindViews() {
        ...
        ilApiVersion = (TextInputLayout) findViewById(R.id.il_settings_api_version);
        ...
        etApiVersion = (TextInputEditText) findViewById(R.id.et_settings_api_vertion);
        ...
        pbApiPublicUrl = (ProgressBar) findViewById(R.id.pb_settings_public_url_stat);
        pbApiLocalUrl = (ProgressBar) findViewById(R.id.pb_settings_local_url_stat);
    ...
    private void loadSettings() {
        ...
        etApiVersion.setText(mSettings.getApiVersion().trim());
    ...
    private void saveSettings() {
        ...
        if (!stringEmptyOrNull(etApiVersion.getText().toString().trim())) {
            mSettings.setApiVersion(etApiVersion.getText().toString().trim());
        } else {
            mSettings.setApiVersion("v0");
        }
    ...
    public void lodeHotelInfos() {
        ...
        Log.e("MARWEN", userCall.request().toString());
                    ...
                    if (!hotelSettings.getHotelIsActive()) {
                        ...
                        if (!hotelSettings.getApplicationIsActive()) {
                            ...
                            if (!stringEmptyOrNull(hotelSettings.getHotelIPPublic())) {
                                mSettings.setPublicIp(hotelSettings.getHotelIPPublic());
                                mSettings.setPublicIpEnabled(true);
                            } else {
                                mSettings.setPublicIp("xxx.xxx.xxx.xxx");
                                mSettings.setPublicIpEnabled(false);
                            ...
                            if (!stringEmptyOrNull(hotelSettings.getHotelIPLocal())) {
                                mSettings.setLocalIp(hotelSettings.getHotelIPLocal());
                                mSettings.setLocalIpEnabled(true);
                            } else {
                                mSettings.setLocalIp("xxx.xxx.xxx.xxx");
                                mSettings.setLocalIpEnabled(false);
                            ...
                            if (!stringEmptyOrNull(hotelSettings.getHotelCode())) {
                                mSettings.setHotelCode(hotelSettings.getHotelCode());
                            } else {
                            ...
                            if (!stringEmptyOrNull(hotelSettings.getHotelName())) {
                                mSettings.setHotelName(hotelSettings.getHotelName());
                            } else {
                            ...
                            if (!stringEmptyOrNull(hotelSettings.getAPIVersion())) {
                                mSettings.setApiVersion(hotelSettings.getAPIVersion());
                            } else {
                                mSettings.setApiVersion("v0");
                            }
                        }
